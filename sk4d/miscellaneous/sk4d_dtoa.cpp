...
/* Linking of Skia4Delphi's #defines to Gay's #defines starts here. */

#if !defined(SK4D_CPU_BIG_ENDIAN) && !defined(SK4D_CPU_LITTLE_ENDIAN) && !defined(SK4D_CPU_MIDDLE_ENDIAN)
    #if defined(__BYTE_ORDER__)
        #if __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__
            #define SK4D_CPU_BIG_ENDIAN
        #elif __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
            #define SK4D_CPU_LITTLE_ENDIAN
        #elif __BYTE_ORDER__ == __ORDER_PDP_ENDIAN__
            #define SK4D_CPU_MIDDLE_ENDIAN
        #endif
    #else
...
#if defined(SK4D_CPU_BIG_ENDIAN) + defined(SK4D_CPU_LITTLE_ENDIAN) + defined(SK4D_CPU_MIDDLE_ENDIAN) != 1
    #error "Multiple endianness defined."
#endif

#ifdef SK4D_CPU_LITTLE_ENDIAN
    #define IEEE_8087
#else
    #define IEEE_MC68k
#endif

// It's a fix for the middle endian, remember to comment out the Storeinc ​​definition.
#if defined(SK4D_CPU_LITTLE_ENDIAN) + defined(SK4D_CPU_MIDDLE_ENDIAN)
...
/* End Skia4Delphi #define linking */
...
retlow1:
 ...
 double
sk4d_strtod(const char *s00, char **se)
{
